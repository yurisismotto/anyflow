...
import io.github.yurisismotto.anyflow.ui.AppPickerScreen
...
class AppPickerUiTest {
    ...
    private fun show(
        ...
        apps: List<io.github.yurisismotto.anyflow.notifications.NotificationApp> = catalogue,
    ...
    @Test
    fun anyflows_own_package_is_not_offered() {
        ...
        //
        // The inputs are deliberately hostile: AnyFlow's own package arrives
        ...
        compose
            .onAllNodes(isToggleable() and hasContentDescription("AnyFlow"), useUnmergedTree = true)
            .assertCountEquals(0)
        compose.onAllNodesWithText("AnyFlow").assertCountEquals(0)
