package dev.fedroid.bridge.capability
...
import dev.fedroid.bridge.proto.capabilities.BatteryState
import dev.fedroid.bridge.proto.capabilities.ChargingState
...
class BatteryCapability(
    ...
    override suspend fun onPeerDisconnected(peer: dev.fedroid.bridge.identity.Fingerprint) {
        remote.set(null)
    }
