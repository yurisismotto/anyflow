package dev.fedroid.bridge.service
...
class ConnectionService : LifecycleService() {
    ...
    private fun ensureConnecting() {
        ...
        connectionJob = lifecycleScope.launch {
            val app = application as FedroidApp
    ...
    companion object {
        ...
        const val ACTION_STOP = "dev.fedroid.bridge.STOP"
