 ...
 * and AnyFlow really retained something to open. That is exactly the
 * condition the brief asks the button to be drawn on.
 */
sealed interface OpenAction {

    /**
     * There is a file, and AnyFlow still holds a way to reach it.
     *
    ...
    /**
     * Outgoing only. AnyFlow no longer holds a read grant for the file it
...
object FilesOpen {
     ...
     * @param hasTarget whether AnyFlow retained anything to open at all — the
