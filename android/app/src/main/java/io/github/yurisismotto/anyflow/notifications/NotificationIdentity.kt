...
object NotificationIdentity {
     ...
     */
    const val ID_DOMAIN = "anyflow/notifications.v1/id/v1"

    /** ADR-0016 / [02 §6.5]: the group digest's own domain. */
    const val GROUP_DOMAIN = "anyflow/notifications.v1/group/v1"

    /** ADR-0016 §11 / [02 §5.4]: the content digest's own domain. */
    const val CONTENT_DOMAIN = "anyflow/notifications.v1/content/v1"
     ...
     *
     * ```text
     * SHA-256( "anyflow/notifications.v1/content/v1"
     *        || len32(app_id)    || app_id
