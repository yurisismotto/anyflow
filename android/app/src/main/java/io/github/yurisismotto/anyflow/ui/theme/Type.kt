...
/**
 * The AnyFlow scale expressed as a Material 3 [Typography].
 *
 ...
 */
val AnyFlowTypography = Typography(
    displayLarge = AnyFlowType.display.copy(fontSize = 40.sp, lineHeight = 48.sp),
    displayMedium = AnyFlowType.display.copy(fontSize = 36.sp, lineHeight = 44.sp),
    displaySmall = AnyFlowType.display,
    headlineLarge = AnyFlowType.title.copy(fontSize = 28.sp, lineHeight = 36.sp),
    headlineMedium = AnyFlowType.title,
    headlineSmall = AnyFlowType.heading,
    titleLarge = AnyFlowType.heading,
    titleMedium = AnyFlowType.subtitle,
    titleSmall = AnyFlowType.body.copy(fontWeight = FontWeight.SemiBold),
    bodyLarge = AnyFlowType.body.copy(fontSize = 16.sp, lineHeight = 24.sp),
    bodyMedium = AnyFlowType.body,
    bodySmall = AnyFlowType.caption,
    labelLarge = AnyFlowType.body.copy(fontWeight = FontWeight.Medium),
    labelMedium = AnyFlowType.label,
    labelSmall = AnyFlowType.caption.copy(fontWeight = FontWeight.Medium, fontSize = 11.sp),
)
