...
import io.github.yurisismotto.anyflow.notifications.SourceIdMap
...
class NotificationIdentityTest {
    ...
    fun `the domain strings are exactly the approved ones`() {
        assertEquals("anyflow/notifications.v1/id/v1", NotificationIdentity.ID_DOMAIN)
        assertEquals("anyflow/notifications.v1/group/v1", NotificationIdentity.GROUP_DOMAIN)
        assertEquals("anyflow/notifications.v1/content/v1", NotificationIdentity.CONTENT_DOMAIN)
    }
