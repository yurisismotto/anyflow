...
import io.github.yurisismotto.anyflow.proto.capabilities.NotificationImportance
import io.github.yurisismotto.anyflow.proto.capabilities.NotificationOutcome
import io.github.yurisismotto.anyflow.proto.capabilities.NotificationPrivacy
 ...
 * notification.
 *
 * Must stay in lockstep with `anyflow_core::notifications` and
...
class NotificationsProtocolTest {
     ...
     * content is the whole update mechanism, on every platform AnyFlow targets.
     */
    @Test
     ...
     *
     * The structural version of this check lives in `anyflow-proto`'s
