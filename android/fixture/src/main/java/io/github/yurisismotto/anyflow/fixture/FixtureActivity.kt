package io.github.yurisismotto.anyflow.fixture
...
/**
 * The AnyFlow notification fixture. **Test only.**
 *
 ...
 * ```
 *
 * Every operation answers on logcat under the tag `AnyFlowFixture`, with the
...
class FixtureActivity : Activity() {
    ...
    private fun perform(op: String) {
        ...
        val title = intent.getStringExtra(EXTRA_TITLE) ?: "AnyFlow fixture"
    ...
    private fun ensureChannels() {
        ...
        val channel = NotificationChannel(
            ...
            description = "Test notifications for AnyFlow certification"
    ...
    companion object {
        private const val TAG = "AnyFlowFixture"
        const val CHANNEL_ID = "anyflow-fixture"
        private const val GROUP_KEY = "anyflow-fixture-group"
        ...
        private val USAGE = """
            ...
            This app posts notifications on demand so that AnyFlow's
            ...
            Drive it from a computer:
              ...
              adb shell am start \
                -n io.github.yurisismotto.anyflow.fixture/.FixtureActivity \
