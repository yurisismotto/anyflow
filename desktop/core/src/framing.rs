...
pub async fn write_envelope<W: AsyncWrite + Unpin>(
    w: &mut W,
    envelope: &fedroid_proto::v1::Envelope,
) -> Result<()> {
...
pub async fn read_envelope<R: AsyncRead + Unpin>(r: &mut R) -> Result<fedroid_proto::v1::Envelope> {
    ...
    Ok(fedroid_proto::v1::Envelope::decode(&body[..])?)
}
