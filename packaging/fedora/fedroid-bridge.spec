...
Version:        0.1.0
Release:        1%{?dist}
Summary:        Local-first continuity bridge between Android and Fedora

License:        Apache-2.0
URL:            https://github.com/yuri/fedroid-bridge
...
%description
Fedroid Bridge connects an Android phone to a Fedora workstation over the
...
This package provides the user-session daemon and the fedroid command-line
...
%install
install -Dpm0755 desktop/target/release/fedroid-bridge %{buildroot}%{_bindir}/fedroid-bridge
install -Dpm0755 desktop/target/release/fedroid        %{buildroot}%{_bindir}/fedroid
install -Dpm0644 packaging/fedora/fedroid-bridge.service \
    %{buildroot}%{_userunitdir}/fedroid-bridge.service
...
%license LICENSE
%doc README.md docs/
%{_bindir}/fedroid-bridge
%{_bindir}/fedroid
%{_userunitdir}/fedroid-bridge.service

%post
cat <<'EOF'
Fedroid Bridge installed. To start it for your user:
